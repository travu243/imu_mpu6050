...
//1, supports ucos
#define SYSTEM_SUPPORT_OS		0		//Defines whether the system folder supports UCOS
	 
//Bit-band operation, to achieve GPIO control function similar to 51
//For specific implementation ideas, refer to Chapter 5 (pages 87-92) of <<CM3 Authoritative Guide>>.
